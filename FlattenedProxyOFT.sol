...
// File deps/npm/@openzeppelin/contracts@5.0.1/utils/introspection/IERC165.sol
...
// File deps/npm/@openzeppelin/contracts@5.0.1/utils/introspection/ERC165.sol
...
abstract contract OFTCore is NonblockingLzApp, ERC165, IOFTCore {
    ...
    constructor(address _lzEndpoint, address initialOwner)
        ...
        Ownable(initialOwner) // Correctly passing initialOwner to the Ownable constructor
    {
        // No need to set initialOwner = msg.sender; here
    }
...
// File deps/npm/@openzeppelin/contracts@5.0.1/utils/Address.sol
...
// File deps/npm/@openzeppelin/contracts@5.0.1/token/ERC20/utils/SafeERC20.sol
...
contract ProxyOFT is OFTCore {
    ...
    constructor(address _lzEndpoint, address _token, address initialOwner) OFTCore(_lzEndpoint, initialOwner) {
